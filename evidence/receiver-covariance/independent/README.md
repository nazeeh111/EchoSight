...
These files preserve the exact executed reviewer probes, original outputs, test log, inspected-source hashes and report for commit `37d355f786e1fa337a0f50f1fda4d6eb3c5eb0f9`. `artifact-sha256.json` identifies the archived bytes. The report is also copied without modification to `evidence/independent-review-37d355f-receiver-covariance.md`.
