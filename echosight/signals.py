...
def process_recording(samples, sample_rate_hz, probe, capture_id, sound_speed_m_s=343., cancel=None):
    ...
    """
    result = dict(capture_id=capture_id,status='rejected',diagnostics=[],clock={},candidates=[])
